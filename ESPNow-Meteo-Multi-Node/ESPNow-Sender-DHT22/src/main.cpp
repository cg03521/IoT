...
constexpr char LOCATION_LABEL[] = "Camera";
...
// La pressione non viene più utilizzata.
// Il DHT22 non dispone di un sensore di pressione.
...
// ============================================================================
// LETTURA DHT22 + VALIDAZIONE + INVIO
// ============================================================================
...
bool readAndSendData()
{
    ...
    // DHT22
    //
    // Il DHT22 necessita di un intervallo sufficiente tra l'accensione
    // e la prima lettura.
    // ========================================================================
    ...
    // La pressione è sempre zero perché il DHT22
    // non misura la pressione atmosferica.
    constexpr float sendPress = 0.0F;
    ...
    // La pressione non viene aggiornata:
    // il DHT22 non dispone di un sensore di pressione.
    ...
    // IMPORTANTE:
    // il DHT22 non misura la pressione.
    // Il Receiver riconoscerà pressure == 0 come assenza
    // del dato di pressione.
...
void setup()
{
    ...
    Serial.println(
        F("DHT22 inizializzato su D4 (GPIO2)")
    );
